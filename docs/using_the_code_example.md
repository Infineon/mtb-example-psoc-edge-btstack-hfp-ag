...
The following example clones the "[HFP-AG](https://github.com/Infineon/mtb-example-psoc-edge-btstack-hfp-ag)" application with the desired name "HFP AG" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-hfp-ag --user-app-name HFP-AG --target-dir "C:/mtb_projects"
   ```
