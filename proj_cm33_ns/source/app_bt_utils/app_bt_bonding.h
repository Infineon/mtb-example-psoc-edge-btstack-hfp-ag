...
#define  BOND_INDEX_MAX                      (3U)
/* LE Key Size */
#define  KEY_SIZE_MAX                        (0x10U)
...
/* Structure to store info that goes into serial flash - it holds the number
 * of bonded devices, remote keys and local keys */
typedef struct
{
